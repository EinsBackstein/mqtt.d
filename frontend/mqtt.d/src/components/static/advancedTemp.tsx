...
const AdvancedTemp = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-center w-[450px] max-h-[200px] bg-secondary rounded-4xl ring-1 ring-info/20 shadow-md shadow-info/30 p-4">
    <div className="flex flex-col w-full h-full pt-4">
      ...
      <p className="text-3xl text-info font-bold pb-0.5">3.5°C ↘</p>
