...
export function MultiSelect({
  ...
  return (
    <Command className="overflow-visible ring-offset-background rounded-md focus-within:ring-2 focus-within:ring-ring bg-input/30 focus-within:ring-offset-2 border border-input">
